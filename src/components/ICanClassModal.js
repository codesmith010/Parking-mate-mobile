...
const ICanClassModal = ({
  modalVisible,
  handleModalVisibility,
  data,
  handleRefreshCanCover,
}) => {
  ...
  // Handle Delete
  const handleDeleteCanCoverClass = async (classID, needCoverID) => {
    console.log("classID, ", classID, " needCoverID  ", needCoverID);
    console.log("handleRefreshNeed: ", () => handleRefreshCanCover);
    handleModalVisibility();
    const deleteDispatch = await dispatch(
      deleteCanCoverSpecific({
        classID: classID,
        userID: user._id,
        needCoverID: needCoverID,
      })
    );
  ...
  const handleViewStudents = async (studentData, classID) => {
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.modalViewText}>
              ...
              <Text style={styles.modalText}>
                Class : {data?.needCoverClassID?.ClassID?.ClassName}
              </Text>
              <Text style={styles.modalText}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                handleViewStudents(
                  data?.needCoverClassID?.ClassID?.Students,
                  data?.needCoverClassID?.ClassID?._id
                )
              }
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                handleDeleteCanCoverClass(data._id, data.needCoverClassID._id)
              }
            >
