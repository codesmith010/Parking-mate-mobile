...
const IModalBookHistoryCanCover = ({
  modalVisible,
  ...
  const contactInstructor = async (countryName, contactNumber) => {
    ...
    const phoneNumber = phoneCode + contactNumber; // Instructor's phone number

    // const separator = Platform.OS === "ios" ? "&" : "?";
    // const url = `sms:${phoneNumber}${separator}`;
...
export default IModalBookHistoryCanCover;
