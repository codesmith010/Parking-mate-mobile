...
const SModal = ({ modalVisible, handleModalVisibility, data }) => {
  ...
  const handleBooking = async () => {
    ...
    const dispatchCreateBooking = await dispatch(
      createBooking({
        userID: user._id,
        classID: data._id,
    ...
    if (dispatchCreateBooking) {
      Alert.alert(dispatchCreateBooking.payload.message);
      return;
    }
  };
            ...
            {!isLoading ? (
              ...
              >
                <Text style={styles.textStyle}>
                  {isEnrolled ? "Already Enrolled" : "Book"}
                </Text>
              </TouchableOpacity>
            ) : (
