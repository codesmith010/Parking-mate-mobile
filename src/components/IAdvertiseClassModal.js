...
const IAdvertiseClassModal = ({
  ...
  // Handle Delete
  const handleDeleteAdvertiseClass = async (classID) => {
    handleModalVisibility();
  ...
  // Handle Repeat Class
  const handleRepeatClass = async (classData) => {
    handleModalVisibility();
    navigation.navigate("AdvertiseClass", {
      ClassesQuery: classData,
    });
  };

  // Handle View Students Class
  const handleViewStudents = async (studentData, classID) => {
    console.log("advertiseclassmodalstudent: ", studentData);
    handleModalVisibility();
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleRepeatClass(data)}
            >
              <Text style={styles.textStyle}>Repeat Class</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.button,
              ...
              onPress={() => handleViewStudents(data?.Students, data._id)}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => handleDeleteAdvertiseClass(data._id)}
            >
...
export default IAdvertiseClassModal;
